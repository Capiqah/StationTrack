...
$stationery_id = $_GET['equipid'];

// First delete from related request table
$deleteRequestSQL = "DELETE FROM request_analysis WHERE stationery_id = '$stationery_id'";
$conn->query($deleteRequestSQL);

// Then delete from main stationery table
$deleteSQL = "DELETE FROM stationery WHERE stationery_id = '$stationery_id'";
$deleteResult = $conn->query($deleteSQL);

// confirmation after delete the request data
