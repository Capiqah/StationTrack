...
<html>
<head>
    <title>ADMIN | STATIONERY LIST</title>
...
<li><b><a href="user_dashboard.php" title="Home"></a></b></li><li><b><a href="user_dashboard.php" title="Home"></a></b></li><li><b><a href="user_dashboard.php" title="Home"></a></b></li><li><b><a href="user_dashboard.php" title="Home"></a></b></li><li><b><a href="user_dashboard.php" title="Home"></a></b></li><li><b><a href="user_dashboard.php" title="Home"></a></b></li><li><b><a href="admin_dashboard.php" title="Home">Home</a></b></li>
  ...
  <!-- Add admin button -->
        <div style="text-align: center;">
            <a class="back-to-home" href="stationery_management.php">Add Stationery </a>
        </div>
        <br>
    </br>
    <br>
...
$ContohSQL = "SELECT * FROM stationery_update WHERE update_id LIKE '" . isset($_POST['stationtrack_updateid']). "%'";
...
while ($row = $hasilQuery->fetch_array()) {
    echo "<tr>
        ...
        <td>" . $row["update_quantity"]."</td>
        <td>" . $row["update_left"] . "</td>
       <td>" . $row["update_uom"] . "</td>
        <td class='action-cell'>
            <div class='action-buttons'>
                <a class='button update-button' href='stationery_update.php?studid={$row['update_id']}'>Update</a>
                <a class='button delete-button' href='stationery_delete.php?studid={$row['update_id']}'>Delete</a>
            </div>
        </td>
