...
<html>
<head>
    <title>STATIONTRACK | DELETE REQUEST</title>
...
$ContohSQL = "SELECT * FROM stationery WHERE stationery_id = '".$_GET['studid']."' ";
...
echo "<form method= 'POST' action ='after_delete.php?equipid=".$_GET['studid']."'>";
...
$_POST["stationery_name"]."'></td></tr>";

echo "<tr><td>Quantity</td><td><input type= 'text' name='txtModfield3' size='20' value='".
$_POST["stationery_quantity"]."'></td></tr>";

echo "<tr><td>Description</td><td><input type= 'text' name='txtModfield4' size='20' value='".
$_POST["stationery_description"]."'></td></tr>";


echo "<tr><td>Date</td><td><input type= 'date' name='txtModfield5' size='20' value='".
$_POST["stationery_date"]."'></td></tr>";
