...
<html>
<head>
    <title>STATIONTRACK | DELETE SUPPLIER</title>
...
$ContohSQL = "SELECT * FROM supplier WHERE supplier_id = '".$_GET['studid']."' ";
...
echo "<form method= 'POST' action ='after_deletesupplier.php?equipid=".$_GET['studid']."'>";
...
echo "<tr><td>Supplier ID</td><td><input type= 'text' name='txtModfield1' size='20' value='".
$_POST["supplier_id"]."'></td></tr>";

echo "<tr><td>Supplier Name</td><td><input type= 'text' name='txtModfield2' size='20' value='".
$_POST["supplier_name"]."'></td></tr>";

echo "<tr><td>Phone No</td><td><input type= 'text' name='txtModfield3' size='20' value='".
$_POST["supplier_phone"]."'></td></tr>";

echo "<tr><td>Address</td><td><input type= 'text' name='txtModfield4' size='20' value='".
$_POST["supplier_address"]."'></td></tr>";


echo "<tr><td>Link</td><td><input type= 'url' name='txtModfield5' size='20' value='".
$_POST["supplier_link"]."'></td></tr>";
