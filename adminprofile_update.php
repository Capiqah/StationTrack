...
$ContohSQL = "SELECT * FROM admin WHERE admin_id = '".$_GET['studid']."' ";
...
echo "<form method= 'POST' action ='afterupdate_profileadmin.php?equipid=".$_GET['studid']."'>";

//Create Table

echo "<table>";

//Looping using a while
while ($_POST = $hasilQuery->fetch_array())

{
//admin profile for update
echo "<tr><td>Admin ID</td><td><input type= 'text' name='txtModfield1' size='20' value='".
$_POST["admin_id"]."'></td></tr>";

echo "<tr><td>Admin Name</td><td><input type= 'text' name='txtModfield2' size='20' value='".
$_POST["admin_name"]."'></td></tr>";

echo "<tr><td>Email Address</td><td><input type= 'text' name='txtModfield3' size='20' value='".
$_POST["admin_email"]."'></td></tr>";

echo "<tr><td>Phone Number </td><td><input type= 'text' name='txtModfield4' size='20' value='".
$_POST["admin_phone"]."'></td></tr>";
