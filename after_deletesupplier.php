...
if (!isset($_GET['equipid'])) {
    die("Error: No supplier ID provided.");
}

$supplier_id = $_GET['equipid'];

// First delete from related request table
$deleteRequestSQL = "DELETE FROM supplier WHERE supplier_id = '$supplier_id'";
$conn->query($deleteRequestSQL);

// Then delete from main supplier table
$deleteSQL = "DELETE FROM supplier WHERE supplier_id = '$supplier_id'";
$deleteResult = $conn->query($deleteSQL);

// confirmation after delete the supplier
