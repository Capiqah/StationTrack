...
<html>
<head>
    <title>STATIONTRACK | DELETE STATIONERY</title>
...
$ContohSQL = "SELECT * FROM stationery_update WHERE update_id = '".$_GET['studid']."' ";
...
echo "<form method= 'POST' action ='after_deletestationery.php?equipid=".$_GET['studid']."'>";
...
echo "<tr><td>Stationery ID</td><td><input type= 'text' name='txtModfield1' size='20' value='".
$_POST["update_id"]."'></td></tr>";

echo "<tr><td>Stationery Name</td><td><input type= 'text' name='txtModfield2' size='20' value='".
$_POST["update_name"]."'></td></tr>";

echo "<tr><td>Quantity</td><td><input type= 'text' name='txtModfield3' size='20' value='".
$_POST["update_quantity"]."'></td></tr>";

echo "<tr><td>Quantity Left</td><td><input type= 'text' name='txtModfield4' size='20' value='".
$_POST["update_left"]."'></td></tr>";

echo "<tr><td>UOM</td><td><input type= 'text' name='txtModfield5' size='20' value='".
$_POST["update_uom"]."'></td></tr>";

}

  echo "</table>";
    echo "<button type='submit' name='cmdSubmit' class='delete-button'>Delete</button>";
    echo "</form>";
