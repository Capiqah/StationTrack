...
$ContohSQL= "UPDATE stationery SET staff_id = '". $_POST['txtModfield1']. "', stationery_name = '".
$_POST['txtModfield2']."', stationery_quantity = '".$_POST['txtModfield3']."', stationery_description = '".$_POST['txtModfield4']."',
 stationery_date = '".$_POST['txtModfield5']."' WHERE stationery_id = '".$_GET['equipid']."'";
...
echo "<form action='myrequest.php' method='post'>";
